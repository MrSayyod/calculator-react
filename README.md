...
# Calculator-app
A simple product that assist you with the calculations.
...
[Calculator-app](https://calculator-react-application.herokuapp.com)


## Getting Started:

1. Download the zip file or clone from the git [here](https://github.com/MrSayyod/calculator-react)
   **OR** 
...
Feel free to check the [issues page](https://github.com/MrSayyod/calculator-react/issues).
